  ...
  return (
    <LegalDoc
      ...
      sections={[
        ...
        { h: 'Your account', body: [
          'You sign in with Google or a one-time email link — there’s no password to manage. You’re responsible for the activity on your account and for keeping your email secure. You must be old enough to form a binding contract in your country to use GroupPad.',
        ]},
        { h: 'Your content', body: [
