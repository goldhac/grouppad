...
const FEATURES = [
  ...
  { icon: Scale, h: 'Compare', p: 'Tick two or more homes and hit Compare for a side-by-side with Scout’s verdict. Comparisons are cached, so re-opening one is instant — no re-charge.' },
