...
const SLIDES = [
  ...
  { tag: 'Step 1 of 9', h: 'One board, three sections', p: 'Everything for the trip lives on one board: Recommended (Scout’s ranked top homes), From your group (anything members add), and More homes (auto-pulled live listings). No more links lost in the chat.', v: 'v1', Art: BoardArt },
  { tag: 'Step 2 of 9', h: 'Add any rental: community submissions', p: 'Tap Add (+) and paste an Airbnb, VRBO, Booking or villa link. It’s scraped, priced all-in, and lands under “From your group” for everyone to weigh in on.', v: 'v2', Art: AddArt },
  { tag: 'Step 3 of 9', h: 'Scout ranks every home for your trip', p: 'Our AI reads your itinerary, budget, and must-haves, then sorts the board best-to-worst. Each home shows a one-line “why it ranks here.” Only homes within budget make Recommended.', v: 'v6', Art: ScoutArt },
  { tag: 'Step 4 of 9', h: 'Vote, and watch the shortlist build', p: 'Shared thumbs, not secret hearts. Any home the group likes rises into the Group’s Shortlist on its own.', v: 'v3', Art: VoteArt },
  { tag: 'Step 5 of 9', h: 'The number that ends the argument', p: 'Every home shows the real all-in cost split across your group, recomputed live as people join. Tap a home for the full breakdown, a map, and guest reviews.', v: 'v4', Art: PpArt },
  { tag: 'Step 6 of 9', h: 'Compare finalists with Scout', p: 'Tick two or more homes and hit Compare. Scout weighs price, distance and your must-haves side-by-side and calls a winner. Results are saved, so re-opening a compare is instant.', v: 'v6', Art: ScoutArt },
  { tag: 'Step 7 of 9', h: 'AI video walkthrough', p: 'On a home you’re serious about, generate an AI walkthrough, a short narrated video tour of the best spaces, so the whole group gets a feel for it without a dozen tabs.', v: 'v2', Art: AddArt },
  { tag: 'Step 8 of 9', h: 'Cast your top choice, then lock it', p: 'Everyone stars one top choice; the leaderboard shows where the group stands. The organizer makes one home the official pick; it gets the gold seal and leaves the shortlist. Done.', v: 'v5', Art: LockArt },
  { tag: 'Step 9 of 9', h: 'Make it yours: pick a theme', p: 'Set the whole board’s vibe — Tropical, Coastal, Sunset, Pink Summer or Forest — plus light or dark. The organizer picks a default theme when creating the trip (or later in Manage); you can override it just for yourself from your account menu. Look for the theme swatches.', v: 'v0', Art: BoardArt },
];
